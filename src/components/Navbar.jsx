    ...
    <body>
      <header className='w-full h-12 flex justify-between items-center z-50 fixed bg-nav-bg/60 shadow-xl shadow-neon-orange/20'>
        <div className='flex mx-4 sm:mx-8 mb-1'>
          <h1 className='lg:hidden flex text-3xl text-neon-red font-lacquer'>WATA</h1>
          <h1 className='hidden md:flex text-3xl text-neon-red font-lacquer'>WhoAreTheyActually</h1>
        </div>
        <nav className=' hidden md:flex items-center justify-between ml-[32rem]'>
          <div className='absolute left-[22rem] -top-2'>
            <ul className='hidden md:flex justify-between space-x-1'>
        ...
        <button className='w-8 h-8 text-3xl cursor-pointer relative hover:opacity-80 focus:outline-none md:hidden'>
        ...
        <button className='hidden mx-5 md:flex w-9 h-9 bg-nav-bg hover:bg-neon-yellow hover:shadow-md hover:shadow-neon-green rounded-full justify-center items-center'>
