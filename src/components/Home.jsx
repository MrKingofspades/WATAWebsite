            ...
            <div className='max-w-4xl mx-auto'>
                <section className='flex flex-col-reverse lg:flex-row gap-8 lg:gap-48 justify-center items-center'>
                    <article className='sm:w-1/2'>
                        <h2 className='text-white text-2xl sm:text-3xl md:text-5xl font-metal-mania tracking-widest font-bold text-center'>WhoAreTheyActually <span className=''>Productions</span></h2>
